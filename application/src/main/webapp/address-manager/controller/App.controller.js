...
sap.ui.define([ "sap/ui/demo/addressmgr/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/demo/addressmgr/model/MessageType",
		"sap/ui/demo/addressmgr/service/businessPartner" ], function(
		BaseController, JSONModel, MessageType, businessPartnerService) {
	return BaseController.extend("sap.ui.demo.addressmgr.controller.App", {
		...
		_loadMainModel : function() {
			...
			oModel.attachRequestFailed(function() {
				that.getRouter().getTargets().display("detailMessagePage", {
					messageType : MessageType.NOTHING_AVAILABLE
				});
			});
